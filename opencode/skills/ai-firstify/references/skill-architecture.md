...
| Factor | Project-Level (.opencode/skills/) | User-Level (~/.config/opencode/skills/) |
|--------|----------------------------------|-------------------------------|
...
1. **Zip the folder** -- `zip -r my-skill.zip .opencode/skills/my-skill/`
2. **Push to GitLab** -- include .opencode/skills/ in your repo
3. **Copy directly** -- recipients paste into their .opencode/skills/
