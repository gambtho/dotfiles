...
- Lives in .opencode/skills/ of an existing project or ~/.config/opencode/skills/ for cross-project
...
4. **Create AGENTS.md** using the template from references/project-structure.md, filled with the user's answers from Phase 1
...
8. **Initial commit**
   ```bash
   git add . && git commit -m "Initial project setup with AGENTS.md and [skill-name] skill"
   ```
