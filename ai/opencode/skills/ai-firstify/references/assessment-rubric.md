...
- Sub-agents used appropriately via the AI agent
...
**GREEN:**
- Skills exist in .opencode/skills/
...
ls -R .opencode/skills/ 2>/dev/null
# Check skill length
wc -l .opencode/skills/*/SKILL.md 2>/dev/null
# Check skill prescriptiveness (should have numbered steps)
grep -c "^[0-9]" .opencode/skills/*/SKILL.md 2>/dev/null
# Check for progressive disclosure (references/ dirs)
find .opencode/skills -name "references" -type d 2>/dev/null
```
...
**GREEN:**
- AGENTS.md under 200 lines and well-organized
- Skills use progressive disclosure
- Reference material in references/ directories
- No context pollution

**YELLOW:**
- AGENTS.md is 200-500 lines
...
|--------|------|-------------|
| Created | AGENTS.md | Project context file |
| Created | .gitignore | Standard exclusions |
| Created | .opencode/skills/[name]/SKILL.md | Extracted workflow |
