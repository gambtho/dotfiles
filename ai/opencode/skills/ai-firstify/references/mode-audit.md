...
- Check for .git, .gitignore, .opencode/skills/
- Identify the tech stack, languages, and frameworks

## Step 2: Analyze each dimension

**Dimension 1: Project Structure**
- Does AGENTS.md exist? Is it well-structured and under 500 lines?
...
- Are sub-agents used appropriately within the AI agent?

**Dimension 3: Skill Usage**
- Do skills exist in .opencode/skills/?
...
- Is AGENTS.md focused and well-structured?
- Are large reference documents in separate files (not inlined in AGENTS.md)?
